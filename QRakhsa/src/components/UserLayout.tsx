...
import { Home, User, LogOut, AlertCircle } from 'lucide-react'; // Changed Settings to LogOut and AlertCircle
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex space-x-4">
              ...
              <Link
                ...
                className={`inline-flex items-center px-3 py-2 text-sm font-medium ${
                  isActive('/user') // Changed to /user to match likely route path
                    ? 'text-blue-600 dark:text-blue-500'
                    : 'text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500'
                }`}
              >
